...
export interface Mutation {
  ...
  CompleteEmailVerification: CompleteEmailVerificationResoponse;
...
export interface CompleteEmailVerificationResoponse {
  ok: boolean;
  error: string | null;
}
